...
def test_clients_page_uses_same_wide_shell_as_network():
    ...
    assert '<div class="ui-page ui-page-wide clients-page-shell">' in html
    assert html.index('clients-page-shell') < html.index('clients-studio-toolbar')
    assert html.index('clients-maintenance-strip') < html.index('<dialog id="add-client-dialog"')
